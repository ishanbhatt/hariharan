...
Find this message, and send it to Adrienn Jeszenszki <adrienn.jeszenszki@sophos.com> .
Remember, this is a programming and not a hacking/cracking excercise. Try to use a programming language you think that suits to this problem the most. Should you have any questions, please also address to the address above.
